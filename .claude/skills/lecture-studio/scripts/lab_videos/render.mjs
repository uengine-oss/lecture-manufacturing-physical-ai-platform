...
const LECTURE = path.resolve(process.env.LECTURE_ROOT || '.');
const SYSTEM = process.env.SYSTEM_DIR || `${LECTURE}/system`;
const LV = process.env.LAB_VIDEOS_DIR || `${LECTURE}/video/lab_videos`;
const VENDOR = `${HERE}/vendor`;
const PYTHON = process.env.PYTHON || `${SYSTEM}/.venv/bin/python`;
